...
To use vara-interface, first install it using pip:
...
.. code-block:: python
    ...
    from varainterface import Account
    account = Account()

By default, you will only be able to fetch Chainstate info from
`Robonomics Kusama parachain <https://polkadot.js.org/apps/?rpc=wss%3A%2F%rpc.vara.network%2F#/explorer>`_
